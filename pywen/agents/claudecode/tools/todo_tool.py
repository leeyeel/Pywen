...
class TodoTool(BaseTool):
    ...
    def __init__(self, agent_id: str = None, config=None):
        ...
        super().__init__(
            ...
            description="Manage todo lists for task tracking. Create, update, and organize todo items to track progress on complex tasks. Use this tool FREQUENTLY to track your progress and give users visibility into your work.",
            parameter_schema={
                "type": "object",
                "properties": {
                    "todos": {
